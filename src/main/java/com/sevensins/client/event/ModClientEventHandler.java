...
import com.sevensins.client.renderer.RedDemonRenderer;
...
public class ModClientEventHandler {
    ...
    public static void onRegisterLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
        event.registerLayerDefinition(RedDemonModel.LAYER_LOCATION, RedDemonModel::createBodyLayer);
    }
     ...
     *
     * <p>{@link com.sevensins.entity.RedDemonEntity} uses
     * {@link RedDemonRenderer} with the custom Blockbench model.</p>
     *
     * <p>All other boss demon entities use {@link DemonEntityRenderer} as a shared
    ...
    public static void onRegisterRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(ModEntities.RED_DEMON.get(), RedDemonRenderer::new);
